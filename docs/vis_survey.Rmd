...
This has to be considered when validating to 2019 traffic counts.

```{r, eval=FALSE}
write_csv(add_skims, "data/_private/vis_survey/output/vis_survey.csv")
write_csv(trip_rates, "data/_private/vis_survey/output/vis_generation.csv")
```
